---
name: invisible-whale-network
description: |
  Entity clustering engine that identifies wallets belonging to the same entity using
  transaction timing analysis, gas price patterns, and fund flow graph analysis. Reveals
  the true whale landscape by unmasking multi-wallet operators on BSC.
  Use this skill when users ask about whale tracking, wallet clustering, entity identification,
  coordinated trading detection, or true holder distribution analysis.
metadata:
  author: mefai-dev
  version: "1.0.0"
license: MIT
